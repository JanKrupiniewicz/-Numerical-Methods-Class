function [integration_error, Nt, ft_5, integral_1000] = zadanie1()
    ...
    for i = 1:length(Nt)
        integration_result = calculate_rectangle_method(@f, Nt(i));
    ...
    ft_5 = f(5);
    integral_1000 = calculate_rectangle_method(@f, 1000);

end

function result = calculate_rectangle_method(f, N)
    result = 0;
    a = 0;
    b = 5;
    delta_x = (b - a)/N;
    ...
    for i = 1:N
        ...
        result = result + f((x_i + next_x_i)/2) * delta_x;
    end
end
